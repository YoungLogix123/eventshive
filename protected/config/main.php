...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=eventshi_food',
			'emulatePrepare'   => true,
			'username'         => 'root',
			'password'         => '',
			'charset'          => 'utf8',
...
{
	return array(
	 'available'=>Yii::t("default",'Available'),
	 'unavailable'=>Yii::t("default",'Unavailable'),
	);
}
//stock status///
...
{
	return array(
	 'kg'=>Yii::t("default",'Kilogram'),
	 'g'=>Yii::t("default",'Gram'),
	 'l'=>Yii::t("default",'Litre'),
	);
}
//length measure///
...
function salutation()
{
	return array(
	 'Mr'=>Yii::t("default",'Mr'),
	 'Mrs'=>Yii::t("default",'Mrs'),
	 'Miss'=>Yii::t("default",'Miss'),
	 'Dr'=>Yii::t("default",'Dr'),
	 'Master'=>Yii::t("default",'Master'),
	 'Prof'=>Yii::t("default",'Prof'),
	);
}
//salutation///
...
function gender()
{
	return array(
	 ...
	 'Unspecified'=>Yii::t("default",'Unspecified'),
	);
}
//gender///
...
{
	return array(
	 'Permanent or fixed-term employees'=>Yii::t("default",'Permanent or fixed-term employees'),
	 'Casual employees'=>Yii::t("default",'Casual employees'),
	 'Apprentices or trainees'=>Yii::t("default",'Apprentices or trainees'),
	 'Employment agency staff – also called labour hire'=>Yii::t("default",'Employment agency staff – also called labour hire'),
	 'Contractors and sub-contractors – hired staff'=>Yii::t("default",'Contractors and sub-contractors – hired staff'),
	);
}
//Employment status///
...
{
	return array(
	 'Single'=>Yii::t("default",'Single'),
	 'Married'=>Yii::t("default",'Married'),
	 'Widowed'=>Yii::t("default",'Widowed'),
	 'Separated'=>Yii::t("default",'Separated'),
	 'Registred partnership'=>Yii::t("default",'Registred partnership'),
	 'Unspecified'=>Yii::t("default",'Unspecified'),
	);
}
//gender///
