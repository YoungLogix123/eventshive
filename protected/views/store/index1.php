...
<body>
    ...
    <div class="our_services" style="background-image:  url(assets/img/product/backgroundimg2.jpg);">
        <div class="container">   
            <div class="row">
                <div class="widgets_container">
                    <div class="breadcrumb_content">  
                         <p><h3>We found these stores for you...</h3></p>                 
                    </div>
                    <div class="col-lg-9 col-md-12">
                            <form action="#">
                            <div class="shop_toolbar">                                
                                <h4 style="color: green;">Narrow your search by distance</h4>  
                                    <div class="tag_widget">
                                            <select class="select_option" name="select" id="categori2">
                                                <option selected value="1">10 Km</option>
                                                <option value="2">15 Km</option>
                                                <option value="3">11 Km</option>
                                                <option value="4">12 Km</option>
                                                <option value="5">13 Km </option>
                                            </select>                        
                                    </div>
                                    <div class="slider_content">
                                         <a href="shopfound.php">Search </a>
                                    </div>
                                </div>
                                </form>                               
                            </div>
                    <div class="error_form">                  
                        <p><h3>Can't find your prefered store?</h3></p>
                        <a class="list_button" href="index.php">Submit the Store</a>
                        <p>We will add the store for you</p>
                    </div>
                </div>
            </div>
        </div>    
...
<!--////////////////////////////////load from the database - create the function in the file FunctionsV3.php and then call that here -->

                                    <ul>
                                    <?php if ( $list=FunctionsV3::getProductItem() ): ?>
                                    <?php $x=1;?>
                                    <?php foreach ($list as $val): ?>
                                        <li><a href="about.html"> <?php echo $val['product_item_name'] ?></a></li>
                                    <?php $x++;?>
                                    <?php endforeach;?>
                                    <?php endif;?>
                                    </ul>
