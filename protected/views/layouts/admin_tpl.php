...
<div class="main_wrapper">
  <div class="left_panel left">
    <div class="nav">
      <div class="menu">     
          <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('dashboard'));?>
        <div class="divTag">
          <input type="checkbox" id="b"/>
          <i class="fas fa-angle-double-down logo"></i><label id="labletag" for="b">Order</label>
          <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('order'));?>
        </div>
        <div class="divTag">
          <input type="checkbox" id="a"/>
           <i class="fas fa-angle-double-down logo"></i><label for="a">Finance</label>
          <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Finance'));?>
        </div>
        <div class="divTag">
           <input type="checkbox" id="c"/>
           <i class="fas fa-angle-double-down logo"></i><label id="cvvd" for="c">Lists</label>
          <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Lists'));?>
        </div>
        <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('singleMenus'));?>
        <div class="divTag">
         <input type="checkbox" id="d"/>
         <i class="fas fa-angle-double-down logo"></i><label for="d">Offers and Promotions</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('offerandpromotions'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="e"/>
         <i class="fas fa-angle-double-down logo"></i><label for="e">Reviews</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Reviews'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="f"/>
         <i class="fas fa-angle-double-down logo"></i><label for="f">Withdrawal</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Withdrawal'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="g"/>
         <i class="fas fa-angle-double-down logo"></i><label for="g">Comissions</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Comissions'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="h"/>
         <i class="fas fa-angle-double-down logo"></i><label for="h">Email</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Email'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="i"/>
         <i class="fas fa-angle-double-down logo"></i><label for="i">Notification</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Notification'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="k"/>
         <i class="fas fa-angle-double-down logo"></i><label for="k">Web Settings</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('WebSettings'));?>
        </div>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Printer'));?>
        <div class="divTag">
         <input type="checkbox" id="n"/>
         <i class="fas fa-angle-double-down logo"></i><label for="n">Mobile Apps</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('MobileApps'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="l"/>
         <i class="fas fa-angle-double-down logo"></i><label for="l">SMS</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('SMS'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="m"/>
         <i class="fas fa-angle-double-down logo"></i><label for="m">Fax Service</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('FaxService'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="o"/>
         <i class="fas fa-angle-double-down logo"></i><label for="o">Payment Gateway</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('PaymentGateway'));?>
        </div>
        <div class="divTag">
         <input type="checkbox" id="p"/>
         <i class="fas fa-angle-double-down logo"></i><label for="p">Reports</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Reports'));?>
        </div>
        <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('CustomerProfile'));?>
        <div class="divTag">
         <input type="checkbox" id="q"/>
         <i class="fas fa-angle-double-down logo"></i><label for="q">Groceries & Categories</label>
         <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Grocery_Product_Categories'));?>
        </div>
        <?php $this->widget('zii.widgets.CMenu', Yii::app()->functions->adminMenu('Logout'));?>  
      </div>
