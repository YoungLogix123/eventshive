...
<input type="hidden" name="action" id="action" value="ProductSubCategoryList">
<input type="hidden" name="tbl" id="tbl" value="product_category">
<input type="hidden" name="clear_tbl"  id="clear_tbl" value="clear_tbl">
<input type="hidden" name="whereid"  id="whereid" value="product_sub_category_id">
<input type="hidden" name="slug" id="slug" value="/admin/ProductSubCategory/Do/Add">
