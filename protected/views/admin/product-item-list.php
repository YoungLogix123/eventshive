...
<input type="hidden" name="action" id="action" value="ProductItemList">
<input type="hidden" name="tbl" id="tbl" value="product_item">
<input type="hidden" name="clear_tbl"  id="clear_tbl" value="clear_tbl">
<input type="hidden" name="whereid"  id="whereid" value="product_item_id">
<input type="hidden" name="slug" id="slug" value="/admin/ProductItem/Do/Add">
<table id="table_list" class="uk-table uk-table-hover uk-table-striped uk-table-condensed">  
   <thead>
        <tr>
            <th width="2%"><?php echo Yii::t("default","ID")?></th>
            <th width="7%"><?php echo Yii::t("default","Product Item Name")?></th>
