...
<?php 
if (isset($_GET['id'])){
  if (!$data=Yii::app()->functions->GetShoppingCateory($_GET['id'])){
...
<?php echo CHtml::hiddenField('action','addShoppingCategory')?>
<?php echo CHtml::hiddenField('id',isset($_GET['id'])?$_GET['id']:"");?>
<?php if (!isset($_GET['id'])):?>
<?php echo CHtml::hiddenField("redirect",Yii::app()->request->baseUrl."/admin/ShoppingCategory/Do/Add")?>
<?php endif;?>


<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Shopping Category Name")?></label>
  <?php 
  echo CHtml::textField('shopping_category_name',
  isset($data['shopping_category_name'])?$data['shopping_category_name']:""
...
<div class="uk-form-row"> 
  ...
  <a href="javascript:;" id="sau_upload_file" 
   class="button uk-button" data-progress="sau_progress" data-preview="image_preview" data-field="ShoppingCategoryImage">
    <?php echo t("Browse")?>
  </a>
</div>
...
<div class="image_preview">
 ...
 if(!empty($image)){
  ...
  echo CHtml::hiddenField('ShoppingCategoryImage',$image);
  echo '<br/>';
