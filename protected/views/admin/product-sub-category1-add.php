...
<?php 
if (isset($_GET['id'])){
  if (!$data=Yii::app()->functions->GetProductSubCateory1($_GET['id'])){
...
<?php echo CHtml::hiddenField('action','addProductSubCategory1')?>
<?php echo CHtml::hiddenField('id',isset($_GET['id'])?$_GET['id']:"");?>
<?php if (!isset($_GET['id'])):?>
<?php echo CHtml::hiddenField("redirect",Yii::app()->request->baseUrl."/admin/ProductSubCategory1/Do/Add")?>
<?php endif;?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Product Sub Category 4 Name")?></label>
  <?php 
  echo CHtml::textField('product_sub_category1_name',
  isset($data['product_sub_category1_name'])?$data['product_sub_category1_name']:""
...
<div class="uk-form-row"> 
  ...
  <a href="javascript:;" id="sau_upload_file" 
   class="button uk-button" data-progress="sau_progress" data-preview="image_preview" data-field="ProductSubCategory1Image">
    <?php echo t("Browse")?>
  </a>
</div>
...
<div class="image_preview">
 ...
 if(!empty($image)){
  ...
  echo CHtml::hiddenField('ProductSubCategory1Image',$image);
  echo '<br/>';
