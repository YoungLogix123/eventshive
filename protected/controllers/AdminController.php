...
/* Shopping Category */
	public function actionShoppingCategory()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Shopping Category Add");
		       $this->render('shopping-category-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Shopping Category List");
		    $this->render('shopping-category-list');	
		}		
	}
/* Shopping Category */
...
/* Product Category */
	public function actionProductCategory()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Product Category Add");
		       $this->render('product-category-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Product Category List");
		    $this->render('product-category-list');	
		}		
	}
/* Product Category */
...
/* Product Sub Category */
	public function actionProductSubCategory()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Product Sub Category Add");
		       $this->render('product-sub-category-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Product Sub Category List");
		    $this->render('product-sub-category-list');	
		}		
	}
/* Product Sub Category */

/* Product Sub Category 1 */
	public function actionProductSubCategory1()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Product Sub Category 4 Add");
		       $this->render('product-sub-category1-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Product Sub Category 4 List");
		    $this->render('product-sub-category1-list');	
		}		
	}
/* Product Sub Category 1 */

/* Product Sub Category 2 */
	public function actionProductSubCategory2()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Product Sub Category 5 Add");
		       $this->render('product-sub-category2-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Product Sub Category 5 List");
		    $this->render('product-sub-category2-list');	
		}		
	}
/* Product Sub Category 2 */
...
/* Product Item */
	public function actionProductItem()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Product Item Add");
		       $this->render('product-item-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Product Item List");
		    $this->render('product-item-list');	
		}		
	}
/* Product Item */
...
/* Customer Profile */
	public function actionCustomerProfile()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Customer Profile Add");
		       $this->render('customer-profile-add');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Customer Profile List");
		    $this->render('customer-profile-list');	
		}	
...
/* Customer Profile */
	public function actionCustomerProfile2()
	{
		if (isset($_GET['Do'])){
	   	   if ($_GET['Do']=="Add"){
			   $this->crumbsTitle=Yii::t("default","Customer Profile Add2");
		       $this->render('customer-profile-add2');
	   	   }   	   	   
		} else {
		    $this->crumbsTitle=Yii::t("default","Customer Profile List2");
		    $this->render('customer-profile-list2');	
		}	
...
///offers/////
	...
	{
		$this->crumbsTitle=Yii::t("default","Offers List");
		if (isset($_GET['Do'])){
			$this->crumbsTitle=Yii::t("default","Offers Add/Update");
			$this->render('offers_add');		
		} else $this->render('offers_list');		
	}
///offers/////
