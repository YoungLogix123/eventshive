...
class StoreController extends CController
{
   ...
   $DbExt=new DbExt;
   $query = FunctionsV3::getProductItem();
   $count = clone $query;
   $pagination = new Pagination(['totalCount' => $count->count(), 'defaultPageSize' => 2]);
   ...
   return $this->render('index', [
	...
	Public function actionProduct()
	{
        ...
        return $this->render('product', ['dataProvider' => $dataProvider, 'pagination' => $pagination]);*/
    
		
		$this->render('product');

	/*$criteria=new CDbCriteria();
	$count = FunctionsV3::getProductItem()->count($criteria);
    $pagination=new CPagination($count);

    // results per page
    $pagination->pageSize=6;
    $pagination->applyLimit($criteria);
    $models=FunctionsV3::getProductItem()->findAll($criteria);
...
*/
	...
	Public function actionGrocerysearch()
	{
		$this->render('grocery-search');
	}
	Public function actionShopsfound()
	{
		$this->render('shopsfound');
	}
