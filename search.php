        ...
        <div class="container">   
            ...
            <form action="#">
                ...
                <div class="search_toolbar">                                
                    <div class="widget_fillter">
                        <input placeholder="What are you looking for?" type="text">
                    </div>
                    <div class="widget_fillter">
                        <input placeholder="Choose your Location" type="text">
                    </div>
                    <div class="widget_fillter">
                        <input placeholder="Shop Type/Distance" type="text">
                    </div>
                    <div class="slider_content">
                        <a href="shopsfound.php">Search </a>
                    </div>
                </div>
            </form>
            </div>      
